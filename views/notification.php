		...
		<div class="notificationDisplay">
			<?php
				if($value['notification_type']=="0") {
					...
					echo "<aside><a href='".ROOTPATH."index.php?controller=friends&url=friendsProfile&friendId=".$value['user_id']."' >";
					echo  $value['user_name'] ."</a></aside>";
				...
				if($value['notification_type']=="1") {
					...
					echo "<img src='".$value['user_pic']."' width=30 height=30 class='imgcenter floatl round5' />";
					echo  "<aside>".$value['user_name'] ."</a></aside>";
					...
					if($value['friend_id']==$_SESSION['id']) {
						...
						echo "<br/>	<img src='".$value['friend_pic']."' width=30 height=30 class='imgcenter floatl round5' />";
						echo  "<aside>".$value['friend_name']."</aside> </a>" ;
					}
